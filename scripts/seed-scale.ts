...
const TITLES: Record<Link["category"], string[]> = {
  ...
  home: ["Плед из шерсти", "Керамическая кружка", "Аромасвеча", "Постельное бельё", "Ваза"],
  ...
  sport: ["Коврик для йоги", "Гантели", "Компрессионные гетры", "Бутылка для воды"],
  beauty_health: ["Витамин D3", "Омега-3", "Магний", "Протеиновый батончик"],

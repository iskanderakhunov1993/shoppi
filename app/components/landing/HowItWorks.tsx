const STEPS = [
  {
    n: "01",
    title: "Креатор публикует находку",
  ...
  },
  {
    ...
    body: "Клики считаются автоматически — креатор и бренд видят, что реально интересно.",
  },
];
    ...
    <section id="how" className="px-6 md:px-10 py-16 md:py-24 border-b border-line">
      <div className="max-w-[1200px] mx-auto">
        ...
        <h2 className="font-display text-2xl md:text-3xl mt-3 mb-12 max-w-lg">
          Три шага от находки креатора до вашей покупки.
        </h2>

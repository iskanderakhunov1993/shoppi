    ...
    <section className="relative h-[520px] md:h-[600px] overflow-hidden">
      ...
      <div className="relative h-full flex flex-col justify-end px-6 md:px-10 pb-14 md:pb-20">
        <div className="max-w-[1200px] mx-auto w-full">
          <span className="block text-[11px] uppercase tracking-widest text-white/70 mb-4">
            {eyebrow}
          </span>
          <h1 className="font-display text-white text-4xl md:text-6xl leading-[1.1] mb-6 max-w-3xl">
          ...
          <Link
            href={ctaHref}
            className="inline-block w-fit text-[13px] font-semibold uppercase tracking-wide text-black bg-white px-6 py-3.5 hover:opacity-85 transition-opacity"
          >
            {ctaLabel}
          </Link>
        </div>

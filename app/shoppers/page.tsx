...
const ITEMS = [
  {
    ...
    body: "Заходишь к конкретному креатору и видишь только то, что он выбрал — без рекламы и бесконечного скролла.",
  },
  {
    title: "Сохраняй, чтобы вернуться",
